  ...
  return (<div>
    ...
    <div className="bg-slate-800 text-white rounded-xl p-5 mb-4">
      ...
      <div className="space-y-3">
        <div className="bg-indigo-900 rounded-lg p-3"><div className="flex items-center gap-2 mb-2"><Tag color="purple">META Supranacional</Tag><span className="text-xs text-indigo-300">Beyond home-country control</span></div><div className="flex flex-wrap gap-1">{["Geopolitics","Global Tech","Global Economics","Social/Env Issues","Multilateral Orgs","Trade Blocs","Foreign Gov'ts","Int'l Financial Flows","Foreign MNCs","Other Groups"].map(d=>(<span key={d} className="bg-indigo-800 text-indigo-200 text-xs px-2 py-0.5 rounded">{d}</span>))}</div></div>
      ...
      <div className="mt-4 bg-slate-700 rounded p-3 text-center">
        ...
        <div className="text-slate-400 text-xs mt-1">¿Este driver contribuye de forma <strong>positiva o negativa</strong> a la rentabilidad o al crecimiento rentable?</div>
      </div>
    </div>
    <Card title="Levels AND Trends (Ch.2)" es="Niveles Y Tendencias" color="amber">
      <div className="text-center font-semibold">"Better might still not be good. Worse might still not be bad."</div>
      <div className="text-center text-xs text-slate-500 mt-1">Mejorar no significa necesariamente que esté bien. Empeorar no significa necesariamente que esté mal.</div>
    </Card>
    <Card title="Q1 Template" es="Plantilla de respuesta rápida para Q1" color="green">
      ...
      <div className="mt-2 bg-red-50 border border-red-300 rounded p-2 text-xs">⚠️ Q1 requiere 5 casos diferentes, uno por nivel. <strong>Completa con tus notas de las Sessions 1–8.</strong></div>
    </Card>
  </div>);
}
...
function SparkPosition() {
  return (<div>
    ...
    <div className="bg-gradient-to-br from-green-800 to-green-900 text-white rounded-xl p-5 mb-4">
      ...
      <div className="text-center text-green-300 text-xs mb-4">Ch.3 — Herramienta de análisis a nivel empresa</div>
      <div className="space-y-2">
        {[{l:"S",w:"cope",q:"WHERE? ¿Dónde?",d:"Industries, segments, geography",c:"bg-green-700"},{l:"P",w:"ositioning",q:"HOW? ¿Cómo?",d:"Price/performance + cost + vs. competitors",c:"bg-green-600"},{l:"A",w:"ctivities",q:"DO what? ¿Qué hace?",d:"Tasks to serve customers",c:"bg-emerald-700"},{l:"R",w:"esources",q:"HAVE what? ¿Qué tiene?",d:"Brands, patents, workforce, facilities, financial",c:"bg-emerald-600"},{l:"K",w:"nowledge",q:"KNOW what? ¿Qué sabe?",d:"Market, tech, competitor, process, organizational",c:"bg-teal-700"}].map(s=>(<div key={s.l} className={`${s.c} rounded-lg p-3 flex items-center gap-3`}><div className="text-3xl font-black text-green-200 w-8">{s.l}</div><div className="flex-1"><div className="flex items-baseline gap-2"><span className="font-bold">{s.l}<span className="font-normal">{s.w}</span></span><span className="text-green-300 text-xs">{s.q}</span></div><div className="text-xs text-green-200 mt-0.5">{s.d}</div></div></div>))}
      </div>
    ...
    <Card title="Positioning: The Full Picture (Ch.3, Figs 3.3–3.5)" es="Posicionamiento: Lo más probable en el examen y lo que más se contesta mal" color="red">
      <div className="bg-red-50 border border-red-200 rounded p-3 mb-3 text-center">
        ...
        <div className="text-xs text-slate-500 mt-1">Solo el MARGEN (Precio − Costo) revela la verdad</div>
      </div>
    ...
    <Card title="A-R-K Advantage Logic" es="Lógica de ventaja de Actividades-Recursos-Conocimiento" color="purple">
    ...
    <Card title="Time Dimension (Ch.3)" es="Dimensión temporal de la estrategia" color="cyan">
    ...
    <Card title="General vs. Specific Competitive Advantages (Ch.3)" es="Ventajas competitivas generales vs. específicas" color="amber">
      <div className="grid grid-cols-2 gap-3 text-xs">
        <div className="bg-amber-50 border rounded p-3"><div className="font-bold text-amber-700 mb-1">General Generales</div><div>Built up over time: R&D, brands, manufacturing excellence.</div></div>
        <div className="bg-amber-50 border rounded p-3"><div className="font-bold text-amber-700 mb-1">Specific Específicas</div><div>Why the company succeeds or fails TODAY against specific competitors.</div></div>
      </div>
      <div className="mt-2 text-xs text-center">Hustle = crear ventajas generales para generar continuamente las ventajas específicas necesarias para competir ahora.</div>
    </Card>
    <Card title="Scope Combinations (Ch.3, Fig 3.1)" es="Matriz de combinaciones de Alcance" color="slate">
    ...
    <Card title="Activities & Resources Lists (Lecture Ch.3)" es="Listas de Actividades y Recursos" color="green">
      <div className="grid grid-cols-2 gap-3 text-xs">
    ...
    <Card title="Signals of Value (Ch.3)" es="Señales de valor — impactan la disposición a pagar" color="rose">
...
function IndustryTab() {
  return (<div>
    <SectionTitle es="Análisis a Nivel de Industria (Ch.4)">Industry-Level Analysis</SectionTitle>
    <Card title="Industry Definition — CRITICAL" es="Definición de industria — EXTREMADAMENTE IMPORTANTE" color="red">
    ...
    <Card title="Competition Spectrum" es="Espectro de tipos de competencia" color="amber">
      ...
      <div className="flex justify-between text-xs text-slate-500 px-1"><span>← Más competencia, menor ganancia</span><span>Menos competencia, mayor ganancia →</span></div>
      <div className="mt-2 bg-amber-50 border border-amber-300 rounded p-2 text-xs">⚠️ <strong>"Segmented competition"</strong> — agregado a mano por el profesor. No lo omitas.</div>
    </Card>
    <Card title="Conditions for Perfect Competition" es="Condiciones para competencia perfecta (desviaciones = explican ganancias)" color="slate">
      ...
      <div className="mt-2 text-xs font-semibold text-center">Desviaciones de estas condiciones → explican por qué existen ganancias</div>
    </Card>
    <Card title="Industry-Level Driver Checklist" es="Lista de drivers a nivel de industria" color="blue">
    ...
    <Card title="Barriers to Entry & Exit (Ch.4)" es="Barreras de entrada y salida — explican por qué persisten las diferencias de ganancia" color="purple">
      <div className="grid grid-cols-2 gap-3 text-xs">
        <div><div className="font-semibold text-purple-700 mb-1">Entry Barriers Barreras de entrada:</div><ul className="space-y-0.5 list-disc list-inside"><li>Economies of scale, learning, scope</li><li>Brands and differentiation</li><li>Patents and government regulation</li><li>Access to inputs or distribution</li><li>Expected retaliation</li></ul></div>
        <div><div className="font-semibold text-purple-700 mb-1">Exit Barriers Barreras de salida:</div><ul className="space-y-0.5 list-disc list-inside"><li>Specialized assets</li><li>Strategic barriers</li><li>Emotional barriers</li><li>Large costs of exiting</li></ul></div>
      </div>
    ...
    <Card title="Table 4.3: Features by Competition Type" es="Tabla de características por tipo de competencia" color="slate">
    ...
    <Card title="Competitor Envelope Analysis — CEA (Ch.4)" es="Análisis de envolvente del competidor" color="rose">
    ...
    <Card title="Quality vs. Price Competition (Lecture Ch.4)" es="Competencia por calidad vs. precio" color="green">
...
function MesoCluster() {
  return (<div>
    ...
    <div className="grid grid-cols-2 gap-3 mb-4">
      ...
      <div className="bg-red-50 border-2 border-red-400 rounded-lg p-4"><div className="font-bold text-red-700 text-center mb-2">Substitutes Sustitutos</div><div className="text-center text-2xl mb-2">📉</div><div className="text-xs space-y-1"><div>→ <strong>CONTRACT</strong> demand Contraen demanda</div><div>→ Replace <strong>function</strong>, not just form</div><div>→ Compete for customer's <strong>time or money</strong></div></div></div>
    </div>
    <Card title="Bargaining Power Framework (Buyers & Suppliers)" es="Marco de poder de negociación" color="blue">
      <div className="grid grid-cols-2 gap-3 text-xs">
    ...
    <Card title="Business Ecosystem Warning (Lecture Ch.5 Part 2)" es="Advertencia sobre ecosistemas de negocios" color="red">
      <div className="bg-red-100 border border-red-300 rounded p-3 text-center"><div className="font-bold text-red-800 text-sm">Where is value GENERATED, APPROPRIATED, and DEFENDED?</div><div className="text-xs text-red-700 mt-1">¿Dónde se GENERA, APROPIA y DEFIENDE el valor?</div></div>
    </Card>
    <Card title={`"It's a Wonderful Life" Test (Lecture Ch.5 Part 1)`} es="Si se elimina a un participante, ¿qué pasa?" color="purple"><div className="text-xs">Imagine removing a player from the ecosystem. If the industry would be significantly worse off, that player has substantial power. If barely noticed, they do not.</div></Card>
    <Card title='"When Will Buyers Get the Value?" (Lecture Ch.5 Part 1)' es="¿Cuándo capturarán el valor los compradores?" color="amber">
...
function MacroMeta() {
  return (<div>
    ...
    <Card title="MACRO / NATIONAL (Ch.6)" es="Nivel Nacional" color="blue">
      ...
      <div className="bg-amber-50 border border-amber-300 rounded p-3 text-xs"><strong>Notas Ch.6:</strong> Observa <Tag color="amber">Niveles</Tag> <Tag color="amber">Tendencias</Tag> <Tag color="amber">Disrupción</Tag> <Tag color="amber">Cambios no lineales</Tag></div>
    </Card>
    ...
    <Card title="Writing Standard for Macro & Meta" es="Estándar de escritura para las respuestas" color="red">
      <div className="grid grid-cols-2 gap-3 text-xs">
...
function VrioArk() {
  return (<div>
    ...
    <Card title="VRIO Framework (extended in this course)" es="Marco VRIO (extendido en este curso)" color="purple">
    ...
    <Card title="Q2A: Home Alone — Professor's Own Answer" es="Respuesta del propio profesor (Lecture Notes Ch.5 Part 1, slide 20)" color="green">
      <div className="text-xs text-green-700 font-semibold mb-3 text-center">✅ VERIFICADO: Lecture Notes Ch.5 Part 1, slide 20</div>
      <div className="space-y-3">
      ...
      <div className="mt-3 bg-blue-50 border border-blue-200 rounded p-2 text-xs"><strong>Paralelo Jennifer Lawrence (slide 21):</strong> Hunger Games $500K → HG2 $10M → HG3+4 &gt;$40M.</div>
      <div className="mt-2 text-xs font-semibold text-center">Clave: Lo que es "escaso" CAMBIA con el tiempo. VRIO es dinámico. El poder de negociación sigue a la escasez.</div>
    </Card>
    <Card title="Q2B: Natalie Portman — Three-Picture Deal" es="Pregunta sobre herramientas de influencias externas" color="blue">
    ...
    <Card title="Q2C: Hollywood Flops — Limits of VRIO" es="Límites del VRIO" color="red">
...
function EtaSwatch() {
  return (<div>
    ...
    <Card title="Key Facts to Know Cold" es="Datos que debes saber de memoria" color="blue">
    ...
    <Card title="ETA Timeline" es="Línea de tiempo" color="slate">
    ...
    <Card title="Movement vs Watch Economics" es="Comparación económica: movimientos vs. relojes" color="slate">
      <table className="w-full text-xs"><thead><tr><th className="text-left pb-1"></th><th className="text-left pb-1 text-blue-700">Movements Movimientos</th><th className="text-left pb-1 text-amber-700">Watches Relojes</th></tr></thead>
...
function CramSheet() {
  return (<div>
    ...
    <div className="bg-slate-900 text-white rounded-xl p-5 mb-4">
      ...
      <div className="space-y-2">
        {[
          ["1","Performance is RELATIVE","El desempeño es RELATIVO","blue"],
          ["2","Comprehensive, integrative, dynamic, question-based","Integral, integrativo, dinámico, basado en preguntas","blue"],
          ["3","Five levels. At each: positive or negative?","5 niveles. En cada uno: ¿positivo o negativo?","blue"],
          ["4","Levels AND trends","Niveles Y tendencias","blue"],
          ["5","Industry = similar form + function + direct competition","Industria = forma+función similar+competencia directa","amber"],
          ["6","Full positioning = price AND cost","Posicionamiento completo = precio Y costo","green"],
          ["7","SPARK: Scope, Positioning, Activities, Resources, Knowledge","","green"],
          ["8","VRIO extends to ARK in SPARK","VRIO se extiende al ARK en SPARK","purple"],
          ["9","Complementors EXPAND; substitutes CONTRACT demand","Complementarios expanden; sustitutos contraen demanda","cyan"],
          ["10","Ecosystems: where is value generated, appropriated, defended?","Ecosistemas: ¿dónde se genera, apropia y defiende el valor?","red"],
          ["11","Macro: levels, trends, disruption, non-linearity","Macro: niveles, tendencias, disrupción, no linealidad","blue"],
          ["12","Q2 Home Alone: THE PART → THE KID → THE FRANCHISE","","green"],
          ["13","Q3 ETA: 5yr, CHF 10M, 33% by 2019, more concentrated","","amber"],
          ["14","Barriers to entry/exit allow profit differences to PERSIST","Las barreras hacen que las diferencias de ganancia persistan","purple"],
          ["15","Competitor Envelope Analysis: what if competitors optimize?","Análisis de envolvente: ¿y si los competidores optimizan?","rose"],
          ["16","General vs. Specific advantages → explains hustle logic","Ventajas generales vs. específicas","cyan"],
          ["17",`"Wonderful Life" test: remove a player, does it matter?`,"Elimina a un participante, ¿importa?","purple"],
        ].map(([n,en,es,c])=>{
    ...
    <div className="bg-slate-100 rounded-lg p-4 text-center">
      ...
      <div className="text-xs text-slate-500 mt-1">Identifica el nivel → Identifica el driver → Explica el mecanismo → Juzga el efecto en el desempeño</div>
    </div>
...
export default function App() {
  ...
  return (
    <div className="bg-white min-h-screen">
      <div className="bg-slate-900 text-white px-4 py-3"><div className="text-lg font-bold">STRT 6200 Midterm Study Guide</div><div className="text-xs text-slate-400">English - Español Mexicano | Closed Book</div></div>
