...
function InteractivePentagon() {
  ...
  const levels = [
    ...
    { key:"industry",n:4,pentIdx:2,title:"Micro Industria",sub:"Competitive landscape",items:["Industry Characteristics","Competition","Cooperation","Strategic Groups","Lead Firms","Micro Policies","Micro Institutions"],col:PC.industry },
    { key:"firm",n:5,pentIdx:3,title:"Firm Empresa",sub:"Internal strategy & execution",col:PC.firm,dual:{left:{heading:"Strategy (SPARK+L)",items:["Scope","Positioning","Activities","Resources","Knowledge","Leadership"]},right:{heading:"Execution",items:["Org & Mgmt","Governance","Firm Policies","Firm Institutions"]}}},
  ];
  ...
  return (<div>
    ...
    <ISub>Interactivo: pasa el cursor/toca los niveles · Interactive: hover/tap levels</ISub>
